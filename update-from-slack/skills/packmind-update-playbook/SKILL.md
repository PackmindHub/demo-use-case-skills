...
```
<topic>: <summary> (source: Slack #channel1, #channel2 discussions, YYYY-MM-DD to YYYY-MM-DD)
```

- Extract channel names and date range from the report header
- Scope to channels relevant to this topic when possible
